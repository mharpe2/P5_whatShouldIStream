...
public extension NSPersistentStoreCoordinator {
    ...
    */
    public class func setupSQLiteBackedCoordinator(_ managedObjectModel: NSManagedObjectModel, storeFileURL: URL, completion: @escaping (CoreDataStack.CoordinatorResult) -> Void) {
