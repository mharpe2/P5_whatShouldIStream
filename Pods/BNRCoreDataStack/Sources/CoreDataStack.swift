...
public extension CoreDataStack {
    ...
    */
    public func resetStore(_ resetCallback: @escaping CoreDataStackStoreResetCallback) {
...
public extension CoreDataStack {
    ...
    */
    public func newBatchOperationContext(_ setupCallback: @escaping CoreDataStackBatchMOCCallback) {
        let moc = NSManagedObjectContext(concurrencyType: .privateQueueConcurrencyType)
