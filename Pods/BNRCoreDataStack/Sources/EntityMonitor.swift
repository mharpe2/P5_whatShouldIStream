 ...
 */
open class EntityMonitor<T: NSManagedObject> where T: CoreDataModelable {
...
private class BaseEntityMonitorDelegate<T: NSManagedObject>: NSObject where T: CoreDataModelable {
