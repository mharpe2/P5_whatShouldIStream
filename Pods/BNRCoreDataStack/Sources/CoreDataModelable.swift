...
extension CoreDataModelable where Self: NSManagedObject {
    ...
    */
     ...
     */
    static public func fetchRequestForEntity(inContext context: NSManagedObjectContext) -> NSFetchRequest<AnyObject> {
    ...
    */
    ...
    static fileprivate func removeAllObjectsReturnedByRequest(_ fetchRequest: NSFetchRequest<AnyObject>, inContext context: NSManagedObjectContext) throws {
